...
function RangeInput(props) {
  return (
    ...
    <div>
      <p> How would you rate your overall experience at our studio?</p>

      <div className='flex items-center justify-between mx-auto my-4 '>
        <span className="font-semibold mr-4">Poor</span>
        ...
        <span className="font-semibold ml-4">Excellent</span>
        </div>
    </div>
  )
}
